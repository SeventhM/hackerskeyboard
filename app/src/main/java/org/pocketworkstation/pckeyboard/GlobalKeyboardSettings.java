    ...
    public void initPrefs(SharedPreferences prefs, Resources resources) {
        ...
        addStringPref("pref_keyboard_mode_portrait", new StringPref() {
            public void set(String val) {
                keyboardModePortrait = Integer.parseInt(val);
            }
        ...
        addStringPref("pref_keyboard_mode_landscape", new StringPref() {
            public void set(String val) {
                keyboardModeLandscape = Integer.parseInt(val);
            }
        ...
        addStringPref("pref_slide_keys_int", new StringPref() {
            public void set(String val) {
                sendSlideKeys = Integer.parseInt(val);
            }
        ...
        addStringPref("pref_popup_content", new StringPref() {
            public void set(String val) {
                popupKeyboardFlags = Integer.parseInt(val);
            }

            public String getDefault() {
                return res.getString(R.string.default_popup_content);
            }
        ...
        addStringPref("pref_label_scale_v2", new StringPref() {
            public void set(String val) {
                labelScalePref = Float.parseFloat(val);
            }
        ...
        addStringPref("pref_candidate_scale", new StringPref() {
            public void set(String val) {
                candidateScalePref = Float.parseFloat(val);
            }
        ...
        addStringPref("pref_top_row_scale", new StringPref() {
            public void set(String val) {
                topRowScale = Float.parseFloat(val);
            }
        ...
        addStringPref("pref_ctrl_a_override", new StringPref() {
            public void set(String val) {
                ctrlAOverride = Integer.parseInt(val);
            }

            public String getDefault() {
                return res.getString(R.string.default_ctrl_a_override);
            }
        ...
        addStringPref("pref_chording_ctrl_key", new StringPref() {
            public void set(String val) {
                chordingCtrlKey = Integer.parseInt(val);
            }

            public String getDefault() {
                return res.getString(R.string.default_chording_ctrl_key);
            }
        ...
        addStringPref("pref_chording_alt_key", new StringPref() {
            public void set(String val) {
                chordingAltKey = Integer.parseInt(val);
            }

            public String getDefault() {
                return res.getString(R.string.default_chording_alt_key);
            }
        ...
        addStringPref("pref_chording_meta_key", new StringPref() {
            public void set(String val) {
                chordingMetaKey = Integer.parseInt(val);
            }

            public String getDefault() {
                return res.getString(R.string.default_chording_meta_key);
            }
        ...
        addStringPref("pref_click_volume", new StringPref() {
            public void set(String val) {
                keyClickVolume = Float.parseFloat(val);
            }

            public String getDefault() {
                return res.getString(R.string.default_click_volume);
            }
        ...
        addStringPref("pref_click_method", new StringPref() {
            public void set(String val) {
                keyClickMethod = Integer.parseInt(val);
            }

            public String getDefault() {
                return res.getString(R.string.default_click_method);
            }
