...
public final class GlobalKeyboardSettings {
    private static final String TAG = "HK/Globals";
    ...
    private final Map<String, BooleanPref> mBoolPrefs = new HashMap<>();
    private final Map<String, StringPref> mStringPrefs = new HashMap<>();
    ...
    public void initPrefs(SharedPreferences prefs, Resources resources) {
        ...
        for (String key : mBoolPrefs.keySet()) {
            ...
            if (pref != null) pref.set(prefs.getBoolean(key, pref.getDefault()));
        }
        for (String key : mStringPrefs.keySet()) {
            StringPref pref = mStringPrefs.get(key);
            if (pref != null) pref.set(prefs.getString(key, pref.getDefault()));
        }
    }
