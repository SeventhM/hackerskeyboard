...
public class LatinKeyboard extends Keyboard {
    ...
    private final Drawable mShiftLockIcon;
    private final Drawable mShiftLockPreviewIcon;
    private Drawable mOldShiftIcon;
    private final Drawable mSpaceIcon;
    private final Drawable mSpaceAutoCompletionIndicator;
    private final Drawable mSpacePreviewIcon;
    private final Drawable mMicIcon;
    private final Drawable mMicPreviewIcon;
    private final Drawable mSettingsIcon;
    private final Drawable mSettingsPreviewIcon;
    private final Drawable m123MicIcon;
    private final Drawable m123MicPreviewIcon;
    ...
    public LatinKeyboard(Context context, int xmlLayoutResId, int mode, float kbHeightPercent) {
        ...
        mShiftLockPreviewIcon = ContextCompat.getDrawable(context, R.drawable.sym_keyboard_feedback_shift_locked);
        setDefaultBounds(mShiftLockPreviewIcon);
        mSpaceIcon = ContextCompat.getDrawable(context, R.drawable.sym_keyboard_space);
        mSpaceAutoCompletionIndicator = ContextCompat.getDrawable(context, R.drawable.sym_keyboard_space_led);
        mSpacePreviewIcon = ContextCompat.getDrawable(context, R.drawable.sym_keyboard_feedback_space);
        ...
        mSettingsPreviewIcon = ContextCompat.getDrawable(context, R.drawable.sym_keyboard_feedback_settings);
        setDefaultBounds(mMicPreviewIcon);
        mButtonArrowLeftIcon = ContextCompat.getDrawable(context, R.drawable.sym_keyboard_language_arrows_left);
        mButtonArrowRightIcon = ContextCompat.getDrawable(context, R.drawable.sym_keyboard_language_arrows_right);
        m123MicIcon = ContextCompat.getDrawable(context, R.drawable.sym_keyboard_123_mic);
        m123MicPreviewIcon = ContextCompat.getDrawable(context, R.drawable.sym_keyboard_feedback_123_mic);
        ...
        if (mEnterKey != null) {
            ...
            switch (options&(EditorInfo.IME_MASK_ACTION|EditorInfo.IME_FLAG_NO_ENTER_ACTION)) {
                ...
                case EditorInfo.IME_ACTION_SEARCH:
                    mEnterKey.iconPreview = ResourcesCompat.getDrawable(res, R.drawable.sym_keyboard_feedback_search, null);
                ...
                default:
                    ...
                    mEnterKey.iconPreview = ResourcesCompat.getDrawable(res, R.drawable.sym_keyboard_feedback_return, null);
            ...
            if (mPrefLetter > 0) {
                ...
                if (inside) {
                    ...
                    if (inPrefList(code, pref)) {
                        ...
                        mPrefLetterX = x;
                        mPrefLetterY = y;
                        for (int nearbyKey : nearby) {
                            Key k = nearbyKeys.get(nearbyKey);
